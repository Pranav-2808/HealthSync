...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = () => {
    // Mock Google Login
    login("mock-google-token", { id: "google-1", name: "Google Trainer", email: "trainer@gmail.com" });
    navigate("/");
  };
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2">Sign in to your trainer dashboard</p>
        </div>
        ...
        <div className="glass p-8 rounded-3xl space-y-6">
          ...
          <button 
            ...
            className="w-full py-3.5 border border-slate-200 rounded-2xl font-semibold text-slate-600 flex items-center justify-center gap-3 hover:bg-slate-50 transition-all group"
          >
          ...
          <p className="text-center text-sm text-slate-500">
            Don't have an account? <Link to="/register" className="text-rose-600 font-bold hover:underline">Register Now</Link>
          </p>
        </div>
      </motion.div>
    </div>
